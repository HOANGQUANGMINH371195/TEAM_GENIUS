...
def build_route_plan(query: str, *, settings) -> RoutePlan:
    ...
    return RoutePlan(
        ...
        # rescue and currentness checks before a safe synthesis. A 15s ceiling
        # still tolerates a cold managed Postgres connection; low-risk topical
        # lookups retain the 8s fast path.
        retrieval_budget_ms=(
            15_000
