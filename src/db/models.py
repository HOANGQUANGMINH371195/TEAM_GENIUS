...
_embedding_type = Vector(settings.embedding_dimensions) if settings.embedding_dimensions else Vector()
...
class Relation(Base):
    ...
    __table_args__ = (
        Index("ix_relations_source_target", "source_entity_id", "target_entity_id"),
    )
